...
describe('test interpolate date', function () {
    it('interpolateDate(a, b) interpolates between two dates a and b', function () {
        var i = public_api_1.interpolateDate(new Date(2000, 0, 1), new Date(2000, 0, 2));
