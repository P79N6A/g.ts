...
describe('test interpolate value', () => {
  ...
  it('interpolate(a, b) interpolates RGB colors if b is a string and a color', () => {
    ...
    expect(interpolate('#ff0000', '#0000ff')(0.5)).toEqual('rgb(128, 0, 128)');
    expect(interpolate('#f00', '#00f')(0.5)).toEqual('rgb(128, 0, 128)');
    expect(interpolate('rgb(255, 0, 0)', 'rgb(0, 0, 255)')(0.5)).toEqual('rgb(128, 0, 128)');
    expect(interpolate('rgba(255, 0, 0, 1.0)', 'rgba(0, 0, 255, 1.0)')(0.5)).toEqual('rgb(128, 0, 128)');
    expect(interpolate('rgb(100%, 0%, 0%)', 'rgb(0%, 0%, 100%)')(0.5)).toEqual('rgb(128, 0, 128)');
    expect(interpolate('rgba(100%, 0%, 0%, 1.0)', 'rgba(0%, 0%, 100%, 1.0)')(0.5)).toEqual('rgb(128, 0, 128)');
    expect(interpolate('rgba(100%, 0%, 0%, 0.5)', 'rgba(0%, 0%, 100%, 0.7)')(0.5)).toEqual('rgba(128, 0, 128, 0.6)');

  });

  it('interpolate(a, b) interpolates RGB colors if b is a color', () => {
    expect(interpolate('red', Rgb.create('blue'))(0.5)).toEqual('rgb(128, 0, 128)');
    expect(interpolate('red', Hsl.create('blue'))(0.5)).toEqual('rgb(128, 0, 128)');
  ...
  it('interpolate(a, b) interpolates numbers if b is an object that is coercible to a number', () => {
    expect(interpolate(1, new Number(2))(0.5)).toEqual(1.5);
    expect(interpolate(1, new String('2'))(0.5)).toEqual(1.5);
