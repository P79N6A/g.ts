...
describe('test interpolate round', function () {
    it('interpolateRound(a, b) interpolates between two numbers a and b, and then rounds', function () {
        var i = public_api_1.interpolateRound(10, 42);
    ...
    it('interpolateRound(a, b) does not pre-round a and b', function () {
        var i = public_api_1.interpolateRound(2.6, 3.6);
        expect(i(0.6)).toEqual(3);
    });
});
//# sourceMappingURL=round.spec.js.map