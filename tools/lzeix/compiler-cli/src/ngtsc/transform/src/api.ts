...
import {ConstantPool, Expression, Statement, Type} from '@lzeix/compiler';
...
/**
 * Provides the interface between a decorator compiler from @lzeix/compiler and the Typescript
 * compiler/transform.
 *
 * The decorator compilers in @lzeix/compiler do not depend on Typescript. The handler is
