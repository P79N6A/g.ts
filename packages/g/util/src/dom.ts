 ...
 * @return {String} 属性值
 */
export function getStyle(dom, name, defaultValue) {
  try {
 ...
 * @return {Number} 宽度
 */
export function getWidth(el, defaultValue) {
 ...
 * @return {Number} 高度
 */
export function getHeight(el, defaultValue) {
 ...
 * @return {Number} 高度
 */
export function getOuterHeight(el, defaultValue) {
 ...
 * @return {Number} 宽度
 */
export function getOuterWidth(el, defaultValue) {
