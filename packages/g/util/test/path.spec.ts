...
describe('path util test', function () {
  ...
  it('arr to path', function () {
    ...
    expect(str).toBe(
      'M100,100L200,200V100H100C40,10,65,10,95,80S150,150,180,80Q95,10,180,80T180,80L110,215A30,50,0,0,1,162.55,162.45L172.55,152.45A30,50,-45,0,1,215.1,109.9L315,10A45,45,0,0,0,125,125L125,80A45,45,0,1,0,275,125A45,45,0,0,1,125,275A45,45,0,1,1,275,275R100,200,50,100,30,40Z'
    );
  });
  ...
  it('path to RomToBezier', function () {
    ...
    expect(PathUtil.parsePathArray(rst)).toBe(
      'C91.66666666666667,183.33333333333334,61.666666666666664,126.66666666666667,50,100C38.333333333333336,73.33333333333333,33.333333333333336,50,30,40'
    );
  });
  ...
  it('path to RomToBezier with circle', function () {
    ...
    expect(PathUtil.parsePathArray(rst)).toBe(
      'C103.33333333333333,210,61.666666666666664,126.66666666666667,50,100C38.333333333333336,73.33333333333333,21.666666666666668,23.333333333333332,30,40C38.333333333333336,56.666666666666664,96.66666666666667,190,100,200'
    );
  });
