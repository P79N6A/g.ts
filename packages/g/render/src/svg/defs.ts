...
import * as Arrow from './defs/arrow';
import * as Clip from './defs/clip';
import * as Gradient from './defs/gradient';
import * as Pattern from './defs/pattern';
import * as Shadow from './defs/shadow';
