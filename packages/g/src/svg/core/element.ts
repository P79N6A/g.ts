...
import * as Animate from '../../util/mixin/animation';
import * as Attribute from './mixin/attribute';
import * as Transform from './mixin/transform';
...
export class Element implements Attribute, Transform, EventEmitter, Animate {
  init() {
